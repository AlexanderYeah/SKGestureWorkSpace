...
- (void)viewDidLoad {
	...
	// Do any additional setup after loading the view, typically from a nib.
		NSArray *menuArr = @[@"捏合",@"捏合",@"折线图",@"Pulse",@"Shake",@"Swing",@"Snap",@"Bounce2",@"Expand",@"Hinge",@"Drop"];
...
- (void)btnClick:(UIButton *)btn
{
  ...
  case 0:
    {
		// Sample1
		UIPinViewController *pinVC = [[UIPinViewController alloc]init];
		pinVC.navigationItem.title = @"控制捏合缩放比例";
		pinVC.view.backgroundColor = [UIColor whiteColor];
